...
var LevelStore = /** @class */ (function () {
    function LevelStore(path, writeCache, readCache) {
        var _this = this;
        this.path = path;
    ...
    LevelStore.prototype.connect = function (complete) {
        var _this = this;
    ...
    LevelStore.prototype.disconnect = function (complete) {
        var _this = this;
        utilities_1.fastALL(Object.keys(this._dbIndex), function (table, i, done) {
    ...
    LevelStore.prototype.setID = function (id) {
        this._id = id;
    };
    LevelStore.prototype.makeTable = function (tableName, dataModels) {
        var _this = this;
    ...
    LevelStore.prototype.write = function (table, pk, data, complete) {
    ...
    LevelStore.prototype.delete = function (table, pk, complete) {
    ...
    LevelStore.prototype.read = function (table, pk, callback) {
    ...
    LevelStore.prototype.rangeRead = function (table, rowCallback, complete, from, to, usePK) {
    ...
    LevelStore.prototype.drop = function (table, callback) {
        var _this = this;
    ...
    LevelStore.prototype.getIndex = function (table, getLength, complete) {
        complete(getLength ? this._dbIndex[table].keys().length : this._dbIndex[table].keys());
    };
    LevelStore.prototype.destroy = function (complete) {
        var _this = this;
        utilities_1.fastALL(Object.keys(this._dbIndex), function (table, i, done) {
